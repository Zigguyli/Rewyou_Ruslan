...
public class GameOfThrones {
    ...
    public static void addHouse(Map house, String houseName, String nameHouse, String form, String slogan) {
        house.put(houseName, new House(nameHouse, new Sigil(form, slogan)));
    }

    public static void removeHouse(Map house, String key) {
        house.remove(key);
    }
    ...
    public static void showInfoAll(Map house) {
